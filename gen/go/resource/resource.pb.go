...
const file_resource_proto_rawDesc = "" +
	...
	"\rListResources\x12\x1e.resource.ListResourcesRequest\x1a\x1f.resource.ListResourcesResponse\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/api/v1/resource\x12v\n" +
